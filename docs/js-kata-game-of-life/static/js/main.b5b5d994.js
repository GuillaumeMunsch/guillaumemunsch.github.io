/*! For license information please see main.b5b5d994.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      946: function (e, n, t) {
  ...
  (t.m = e),
    ...
    (t.u = function (e) {
      return "static/js/" + e + ".81001971.chunk.js";
    }),
    ...
    (function () {
      ...
      var n = function (n, r) {
        ...
        r = (self.webpackChunkjs_kata_game_of_life =
          self.webpackChunkjs_kata_game_of_life || []);
    ...
    (function () {
        ...
        s = function (e) {
          var n = (function (e) {
            return e.map(function (e) {
              return [].concat(o(i(e)), [e]);
            });
          })(e);
          return n.filter(function (n) {
            var t = (function (e, n) {
              return i(e).filter(n.has).length;
            })(n, e);
            return (function (e, n) {
              return 3 === n || (e && 2 === n);
            })(e.has(n), t);
      ...
      var d = function (e) {
          var n = a(e.split("|"), 2),
            t = n[0],
            r = n[1];
          return { x: parseInt(t, 10), y: parseInt(r, 10) };
        },
        p = function (e) {
          var n = e.x,
            t = e.y;
        ...
        m = f(function e(n) {
          ...
          !(function (e, n) {
            ...
            (this.getCells = function () {
              return o(t.cells).map(d);
            }),
            (this.filter = function (n) {
              return new e(o(t.cells).map(d).filter(n));
            }),
            (this.has = function (e) {
              return t.cells.has(p(e));
            }),
            (this.map = function (n) {
              return new e(o(t.cells).map(d).map(n).flat());
            }),
            (this.equals = function (e) {
              return (
                t.getCells().every(function (n) {
                  return e.has(n);
                }) && t.cells.size === e.getCells().length
              );
            }),
            (this.cells = new Set(
              null === n || void 0 === n ? void 0 : n.map(p)
            ));
        }),
        h = t(815),
        v = function () {
          ...
          return (
            ...
            (0, h.jsx)("div", {
              ...
              children: t.getCells().map(function (e) {
                var n = e.x,
                  t = e.y;
                return (0,
                h.jsx)("div", { style: { position: "absolute", left: 20 * n, top: 20 * t, width: 19, height: 19, backgroundColor: "aqua", borderRadius: 2, outline: "1px solid #000" } });
              }),
            })
          );
        };
      ...
      n
        ...
        .render((0, h.jsx)(e.StrictMode, { children: (0, h.jsx)(g, {}) })),
        y();
    })();
})();
//# sourceMappingURL=main.b5b5d994.js.map
